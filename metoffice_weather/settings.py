    ...
    'default': 
        {
            ...
            'NAME': os.getenv('POSTGRES_DB', 'metoffice_weather'),
            'USER': os.getenv('POSTGRES_USER', 'postgres'),
            'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'postgres'), # Change in production!
...
STATIC_ROOT = '/usr/src/metoffice_weather/staticfiles'
MEDIA_ROOT = '/usr/src/metoffice_weather/media'
